# Aura Backup Format v1

`.aurabackup` is a UTF-8, versioned JSON document. Version 1 contains its creation time, Aura version, activity records, non-submitted queue records, and non-secret preferences.
