...
struct DiscordSettingsSection: View {
    ...
    var body: some View {
        ...
        Section("Discord") {
            ...
            DisclosureGroup("Customize Rich Presence") {
                ...
                TextField("Activity name", text: $preferences.discordActivityName, prompt: Text("Aura"))
    ...
    private var discordStatusExplanation: String {
        ...
        case .inactive: "Discord is available. Aura will share when music starts."
        case .offline: "Discord Desktop is closed. Aura will connect automatically after you open it."
        case .connecting: "Aura is connecting to Discord now."
        case .connected: "Your current activity can be shared with Discord."
        case .awaitingPermission: "Discord needs permission before Aura can connect."
    ...
    private var previewActivityName: String {
        ...
        return rendered.isEmpty ? "Aura" : rendered
    }
