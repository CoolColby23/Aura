    ...
    var body: some View {
        ...
        VStack(spacing: BrandSpacing.xl) {
            ...
            Group {
                ...
                case 0:
                    IntroStep(
                        title: "Welcome to Aura", symbol: "waveform.circle.fill",
                        text:
                            "Now playing, everywhere. Share tracks from your music apps on Discord and preserve your listening history on Last.fm. Nothing is published until you enable it.",
                        branded: true
                    )
                case 1:
                    VStack(spacing: 14) {
                ...
                default:
                    IntroStep(
                        title: "Aura Is Ready", symbol: "checkmark.circle.fill",
                        text:
                    ...
                    Capsule()
                        .fill(
                            index <= step
                                ...
                                : AnyShapeStyle(BrandColors.graphite.opacity(0.20))
                        )
                        .frame(height: 8)
