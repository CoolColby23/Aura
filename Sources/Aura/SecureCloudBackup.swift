...
enum SecureBackupError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .noBackup: "No encrypted Aura backup was found in iCloud Drive."
        }
    }
}
...
enum ICloudBackupStore {
    private static let fileName = "Aura-Latest.auraencrypted"
    ...
    private static func backupDirectory() throws -> URL {
        ...
        return container.appendingPathComponent("Documents/Aura", isDirectory: true)
    }
}
