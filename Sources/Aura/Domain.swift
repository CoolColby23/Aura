...
struct TrackMetadata: Sendable, Hashable, Codable {
    ...
    var isScrobbleable: Bool {
        let hasMetadata = !title.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty && !artist.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty
...
struct LastFMRemoteTrack: Sendable, Hashable, Identifiable {
    ...
    init?(json: [String: Any]) {
        ...
        let isNowPlaying =
            (attributes?["nowplaying"] as? String) == "true"
