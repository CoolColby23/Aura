...
final class NotificationCoordinator {
    ...
    func notifyOnce(key: String, title: String, body: String, section: DashboardSection) async {
        ...
        await delivery.deliver(identifier: "aura.\(key)", title: title, body: body, section: section)
    }
...
extension Notification.Name {
    static let auraOpenSection = Notification.Name("AuraOpenSection")
    static let auraPrivateModeIntent = Notification.Name("AuraPrivateModeIntent")
}
